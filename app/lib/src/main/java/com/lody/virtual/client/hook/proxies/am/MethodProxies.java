...
class MethodProxies {
    ...
    static class StartActivity extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            Log.d("wwb","intentType="+resolvedType);
            ...
            if (intent.getScheme() != null && intent.getScheme().equals(SCHEME_PACKAGE) && intent.getData() != null) {
                if (intent.getAction() != null && intent.getAction().startsWith("android.settings.")) {
                    ...
                    Log.d("wwb","entir setdata for package:*");
                }
            }
            ...
            int res = VActivityManager.get().startActivity(intent, activityInfo, resultTo, options, resultWho, requestCode, VUserHandle.myUserId());//VAM
    ...
    static class StartService extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            if (serviceInfo != null) {
                Log.d("wwb","entire VAM.startService");
